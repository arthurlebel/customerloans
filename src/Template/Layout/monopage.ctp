    ...
    <nav class="top-bar expanded" data-topbar role="navigation">
        ...
        <div class="top-bar-section">
            <ul class="right">
                <li>
                    <?php
                    echo $this->Html->link('Home', ['controller'=>'Contracts','action'=>'index']);
                    echo "</li><li>";
                ...
                <li>
                    <a href="">CakePHP PDF version 0.0.2</a>
                </li>
                <li><?=
                ...
                <li>
                    <?= $this->Html->link('Espagnol', ['action' => 'changeLang', 'es_MX'], ['escape' => false]) ?>
                </li>
                <li>
